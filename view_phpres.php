...
if (isset($_GET['prescriptionid'])) {
    ...
    if ($resultPrescription->num_rows > 0) {
        ...
        echo "<script>alert('Prescription not found.'); window.location.href='load_pres.php';</script>";
        exit();
    }
    ...
    echo "<script>alert('No Prescription selected.'); window.location.href='load_pres.php';</script>";
    exit();
}
?>
...
<body>
    <div class="container">
        ...
        <div class="action-buttons">
            ...
            <button class="back-button" onclick="window.location.href='load_pres.php'">Back to Prescription List</button>
        </div>
    </div>
</body>
</html>
