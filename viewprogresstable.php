...
<body>
    <div class="container">
        ...
        <button class="add-patient" onclick="window.location.href='progressnote.html'">+ Add Progress Notes</button>
        <button class="back" onclick="window.location.href='progressdash.php'">Back</button>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                                    ...
                                    <a href='updateProgress.php?id=" . $row['progressNId'] . "'>Update</a> | 
                                    <a href='deleteprogress.php?id=" . $row['progressNId'] . "' onclick='return confirm(\"Are you sure you want to delete this record?\");'>Delete</a>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
