...
if (isset($_GET['prescriptionid'])) {
    ...
    if ($resultPrescription->num_rows > 0) {
        ...
        echo "<script>alert('Prescription not found.'); window.location.href='nurse_pres.php';</script>";
        exit();
    }
    ...
    echo "<script>alert('No Prescription selected.'); window.location.href='nurse_pres.php';</script>";
    exit();
}
?>
