...
<body>
    <div class="container">
        ...
        <button class="back" onclick="window.location.href='presdash.php'">Back</button>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        if ($currentPrescriptionId !== $row['prescription_id']) {
                            ...
                            echo "<td rowspan='1'>
                                <button class='view-button' onclick=\"window.location.href='view_prescriptions.php?prescriptionid=" . $row['prescription_id'] . "'\">View</button>
                            </td>";
                            echo "</tr>";
                        } else {
