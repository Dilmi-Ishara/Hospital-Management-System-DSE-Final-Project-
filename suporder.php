...
<head>
    ...
    <title>Supplier Manage Dashboard</title>
        ...
        <main class="main-content">
            ...
            <section>
                ...
                <div class="operation-box">
                    ...
                    <a href="addsuporder.php">Add Supplier Order</a>
                </div>
                <div class="operation-box">
                    <img src="images/view.webp" alt="View Icon">
                    <a href="viewsuporder.php">View Supplier Order</a>
                </div>
            </div>
